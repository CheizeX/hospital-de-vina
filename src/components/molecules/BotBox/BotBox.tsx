...
export const BotBox: FC<webchatProps & BotBoxProps> = function ({
  ...
  const handleAutomatedMessages = (suggestion: any) => {
    ...
    if (!suggestion.subItems || suggestion.subItems.derivation) {
      setLoadingMessage(true);
      setTimeout(() => {
        setAutomatedMessages([
          ...automatedMessages,
                  ...
                  <div className="bot-dialogue__bot-ewc-class">
                    <div className="bot-image-container__bot-ewc-class">
                      ...
                      {message.icon ? (
                        ...
                        <img
                          src={
                            logo || `data:image/svg+xml;base64,${base64Avatar}`
                          }
                    ...
                    <div
                      ...
                      <span className="bot-text__bot-ewc-class">
                        ...
                        message.link !== DERIVATIONS.AGENT ? (
                          <a
                            href={message.link}
                            target="_blank"
                            rel="noreferrer">
                          ...
                          message.link === DERIVATIONS.AGENT ? (
                          <button
                            className="automatized-text-derivation-button__bot-ewc-class"
                            key={index.toString()}
                            type="button"
                            onClick={() => {
                              handleDerivation(DERIVATIONS.AGENT);
                            }}>
                            {message.content}
                          </button>
                        ) : (
